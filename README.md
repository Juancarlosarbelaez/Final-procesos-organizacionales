...
📄 **Ver documento completo**: [`documentation/Definición del problema, necesidad del negocio y estrategia.pdf`](documentacion\Definición del problema, necesidad del negocio y estrategia corporativa.pdf)
...
📄 **Ver diagramas**: [`documentation/Diagrama_BPMN.pdf`](documentacion\Diagrama_BPMN.pdf)
...
📄 **Ver arquitectura**: [`documentation/Pipeline_ArquitecturaDatosEcoModa.pdf`](documentacion\Pipeline_ArquitecturaDatosEcoModa.pdf)
...
📄 **Ver documento completo**: [`documentation/Gobierno_Datos.pdf`](documentacion\Gobierno_Datos.pdf)
